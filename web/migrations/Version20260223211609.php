 ...
 */
final class Version20260223211609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ResetPasswordRequest DROP FOREIGN KEY `FK_RESET_PWD_USER`');
        $this->addSql('DROP TABLE Notification');
        $this->addSql('DROP TABLE ResetPasswordRequest');
        $this->addSql('ALTER TABLE ConstanteVitale CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE consultation_id consultation_id INT NOT NULL, CHANGE date_prise date_prise DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE RapportMedical ADD fichiers JSON DEFAULT NULL, DROP consultation_id, DROP url_pdf, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE dossier_id dossier_id INT NOT NULL, CHANGE contenu contenu LONGTEXT NOT NULL, CHANGE conclusion conclusion LONGTEXT NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE RendezVous DROP medecin_id, CHANGE profil_id profil_id INT NOT NULL, CHANGE statut statut VARCHAR(50) NOT NULL, CHANGE type type VARCHAR(100) NOT NULL, CHANGE motif motif VARCHAR(60) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE Utilisateur DROP totp_secret, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE prenom prenom VARCHAR(100) NOT NULL, CHANGE nom nom VARCHAR(100) NOT NULL, CHANGE type_utilisateur type_utilisateur VARCHAR(255) NOT NULL, CHANGE adresse adresse LONGTEXT DEFAULT NULL, CHANGE specialite_id specialite_id INT DEFAULT NULL, CHANGE is_verified is_verified TINYINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Notification (id BIGINT AUTO_INCREMENT NOT NULL, rendez_vous_id BIGINT NOT NULL, type VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, message TEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, date_envoi DATETIME DEFAULT CURRENT_TIMESTAMP, est_lu TINYINT DEFAULT 0, canal VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`, INDEX rendez_vous_id (rendez_vous_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE ResetPasswordRequest (id INT AUTO_INCREMENT NOT NULL, user_id BIGINT NOT NULL, selector VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, hashed_token VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, requested_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_RESET_PWD_USER (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE Notification ADD CONSTRAINT `Notification_ibfk_1` FOREIGN KEY (rendez_vous_id) REFERENCES RendezVous (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ResetPasswordRequest ADD CONSTRAINT `FK_RESET_PWD_USER` FOREIGN KEY (user_id) REFERENCES Utilisateur (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE ConstanteVitale CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE date_prise date_prise DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE consultation_id consultation_id BIGINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE RapportMedical ADD consultation_id BIGINT DEFAULT NULL, ADD url_pdf VARCHAR(255) DEFAULT NULL, DROP fichiers, CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE contenu contenu TEXT DEFAULT NULL, CHANGE conclusion conclusion TEXT DEFAULT NULL, CHANGE date_creation date_creation DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE dossier_id dossier_id BIGINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE RendezVous ADD medecin_id BIGINT DEFAULT NULL, CHANGE statut statut VARCHAR(50) DEFAULT \'PLANIFIE\', CHANGE type type VARCHAR(50) DEFAULT NULL, CHANGE motif motif VARCHAR(60) NOT NULL, CHANGE profil_id profil_id BIGINT NOT NULL');
